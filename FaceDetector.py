...
class FaceDetector:
    def detect(self, data):
        try:
            ...
            face = face_cascade.detectMultiScale(data.image, scaleFactor=1.05, minNeighbors=5, minSize=(130, 130), flags=cv.CASCADE_SCALE_IMAGE)
            (x, y, w, h) = face[0]
            # for (x, y, w, h) in face:
            ...
            mouth = mouth_cascade.detectMultiScale(faceImage, scaleFactor=1.05, minNeighbors=20, minSize=(20, 20), flags=cv.CASCADE_DO_ROUGH_SEARCH)
